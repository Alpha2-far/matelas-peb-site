...
export const metadata: Metadata = {
  ...
  description:
    "Contactez Matelas PEB pour toute commande ou question. WhatsApp: +229 67 61 18 44. Téléphone: +229 01 67 61 18 44. Livraison gratuite partout au Bénin.",
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <a
                ...
                className="bg-white rounded-2xl p-8 shadow-lg border-2 border-green-500 hover:border-green-600 hover:shadow-xl transition-all text-center group"
              >
                ...
                <p className="text-gray-600 mb-4">Réponse rapide garantie</p>
                <div className="text-green-600 font-bold text-xl">+229 67 61 18 44</div>
                <div className="mt-4 bg-green-600 text-white px-6 py-2.5 rounded-full font-medium inline-block">
                  Discuter maintenant
                </div>
              </a>
              ...
              <a
                ...
                className="bg-white rounded-2xl p-8 shadow-lg border-2 border-indigo-500 hover:border-indigo-600 hover:shadow-xl transition-all text-center group"
              >
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Téléphone</h2>
                <p className="text-gray-600 mb-4">Lun-Sam : 8h-18h</p>
                <div className="text-indigo-600 font-bold text-xl">+229 01 67 61 18 44</div>
                <div className="mt-4 bg-indigo-600 text-white px-6 py-2.5 rounded-full font-medium inline-block">
                  Appeler maintenant
                </div>
              </a>
            </div>
