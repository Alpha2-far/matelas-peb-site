...
const productDetails = [
  {
    ...
    description: "Une nuit de sommeil paisible. Parfait pour tous.",
    features: [
      "Dimensions : 90x190cm ou 100x200cm",
      "Mousse haute densité",
      "Tissu résistant et respirant",
      "Idéal pour chambre individuelle",
      "Livraison gratuite",
    ],
    price: 35000,
  ...
  },
  {
    ...
    description: "Duo parfait pour des nuits douces. Pour un sommeil réparateur.",
    features: [
      "Dimensions : 140x190cm ou 160x200cm",
      "Confort optimal pour deux personnes",
  ...
  },
  {
    ...
    description: "Confort pour toute la famille. Des nuits paisibles et revitalisantes.",
    features: [
      "Dimensions : 180x200cm ou 200x200cm",
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <a
                          ...
                          className="bg-green-600 text-white px-6 py-3 rounded-full font-medium hover:bg-green-700 transition-colors inline-flex items-center gap-2"
                        >
