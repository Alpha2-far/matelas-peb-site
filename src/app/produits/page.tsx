                      ...
                      <div className="mt-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <a
                            ...
                            className="bg-green-600 text-white px-3 py-2.5 rounded-full font-medium hover:bg-green-700 transition-colors inline-flex items-center justify-center gap-1 text-sm"
                          >
                          ...
                          <a
                            href={`https://wa.me/2290166200120?text=Bonjour, je suis intéressé par le ${product.name}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-green-600 text-white px-3 py-2.5 rounded-full font-medium hover:bg-green-700 transition-colors inline-flex items-center justify-center gap-1 text-sm"
                          >
